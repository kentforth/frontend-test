...
const sendEmail = async (number, email) => {
  const templateParams = {
    ...
    Реквизиты для оплаты: Оплатить можно по номеру телефона +7 913 810 2487 (Сбер/T-Банк), а также по <a href="https://www.tinkoff.ru/rm/franchuk.anton2/TX77Z93513/" target="_blank">ссылке</a> напрямую в T-Банк, работает только для владельцев карт T-Банка.
    <br/>
